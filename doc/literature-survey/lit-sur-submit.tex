...
\usepackage[a4paper, vmargin={0.7in,0.7in},hmargin={0.6in,0.6in}]{geometry}
\usepackage{enumitem}
\usepackage{titlesec}

% \titleformat{\section}
% {\normalfont\bfseries}{\thesection}{1em}{}
\titlespacing*{\section}{0pt}{\baselineskip}{0.8\baselineskip}
...
\makeatletter
\begin{flushleft}
    {\LARGE \@title} \\[0em] % Title size and spacing
    \rule{\textwidth}{1pt} \\[0.5em] % Horizontal line
    {\large \@author} \\[0.5em] % Author size and spacing
